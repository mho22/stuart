...
export const kinds : Record<MessageKind, { label : string; hint : string }> = {
	...
	concerns : {
		label : 'Concerns',
		hint : 'What a reviewer would trip over: several stories in one PR, no way to see it works, or AI-assisted work nobody owns. Raised, never blocking — whether it should hold up a review is for the maintainer to decide.',
	},
	reviewer : {
		label : 'Reviewer',
